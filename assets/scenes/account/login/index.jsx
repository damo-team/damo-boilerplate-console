    ...
    return (
      <div className="j-scene j-scene-login">
          ...
          <Tabs.TabPane tab="手机号登录" key={this.tabKeys[1]}>
            ...
            <CustomForm
              ...
              options={[
              {
                ...
                getProps: () => {
                  return {size: 'large', prefix: (<Icon type="mail" className="prefixIcon"/>), suffix: (
                      <Button
        ...
        <div className="elem-other">
          ...
          <Damo.Link className="elem-register" to={Damo.route('/account/signup').resolvePath}>注册账户</Damo.Link>
        </div>
      </div>
    )
  }
